    ...
    return (
      <div className="min-h-screen bg-gray-50 py-16">
        <div className="mx-auto max-w-7xl px-4 text-center">
          <p className="text-lg text-gray-600">Omdirigerar till varukorg...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-gray-50 py-16">
        <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-lg bg-white p-8 text-center shadow-md">
            ...
            <h2 className="mt-4 text-3xl font-bold text-gray-900">Tack för din order!</h2>
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h1 className="mb-8 text-4xl font-bold text-gray-900">Kassa</h1>
        ...
        <form onSubmit={handleSubmit} className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Payment Method */}
            <div className="rounded-lg bg-white p-6 shadow-md">
              <h2 className="mb-4 text-xl font-semibold text-gray-900">Betalningsmetod</h2>
              <select
                name="paymentMethod"
